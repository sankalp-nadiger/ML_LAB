...
optimal_value_minimax, optimal_path_minimax = minimax(game_tree, 2, True)
print("Minimax Optimal value:", optimal_value_minimax)
print("Minimax Optimal path:", optimal_path_minimax)

pruned_count = 0
optimal_value_ab, optimal_path_ab = alpha_beta(game_tree, 2, float("-inf"), float("inf"), True)
print("\nAlpha-Beta Pruned Count:", pruned_count)
print("Alpha-Beta Optimal value:", optimal_value_ab)
print("Alpha-Beta Optimal path:", optimal_path_ab)
